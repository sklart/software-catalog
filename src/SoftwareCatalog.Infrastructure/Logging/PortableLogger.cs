...
public sealed class PortableLogger(IAppPathService paths)
{
    ...
    private void Write(string level, string message)
    {
        ...
        foreach (var file in Directory.EnumerateFiles(paths.LogsDirectory, "*.log").OrderByDescending(File.GetLastWriteTimeUtc).Skip(10)) File.Delete(file);
    }
}
